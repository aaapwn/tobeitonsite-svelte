...
const css = {
  code: ".app.svelte-1ae84js.svelte-1ae84js{display:flex;flex-direction:column;min-height:100vh}main.svelte-1ae84js.svelte-1ae84js{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:64rem;margin:0 auto;box-sizing:border-box}footer.svelte-1ae84js.svelte-1ae84js{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:12px}footer.svelte-1ae84js a.svelte-1ae84js{font-weight:bold}@media(min-width: 480px){footer.svelte-1ae84js.svelte-1ae84js{padding:12px 0}}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="app svelte-1ae84js">${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main class="svelte-1ae84js">${slots.default ? slots.default({}) : ``}</main> <footer class="svelte-1ae84js" data-svelte-h="svelte-1dlfr5"><p>visit <a href="https://kit.svelte.dev" class="svelte-1ae84js">kit.svelte.dev</a> to learn SvelteKit</p></footer> </div>`;
});
export {
  Layout as default
};
